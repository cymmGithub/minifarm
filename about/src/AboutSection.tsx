...
{`  PIPELINE 1 — CLIENT          PIPELINE 2 — MASTER
  ...
  ┌─────────────────────┐      ┌─────────────────────┐
  │ Checkout repo       │      │ Deploy master apps  │
  └─────────┬───────────┘      └─────────┬───────────┘
            ▼                            ▼
  ┌─────────────────────┐      ┌─────────────────────┐
...
export function AboutSection() {
	...
	return (
		<article className="crt-screen bg-[#0a0a08] min-h-screen font-mono text-amber-500/80">
			...
			{/* Public header — links to source */}
			<header className="relative z-50 border-b border-amber-500/15 bg-[#0a0a08]/80 backdrop-blur-sm">
				<div className="max-w-5xl mx-auto px-6 py-3 flex items-center justify-between">
					<span className="font-terminal text-sm text-amber-500/40 tracking-wider">
						[ MINIFARM ]
					</span>
					<a
						href="https://github.com/cymmGithub/minifarm"
						target="_blank"
						rel="noopener noreferrer"
						className="font-mono text-xs text-amber-500/50 hover:text-amber-400 transition-colors"
					>
						[ source ] github.com/cymmGithub/minifarm
					</a>
				</div>
			</header>
				...
				<div className="absolute bottom-0 left-0 right-0 px-6 pb-10 md:pb-14">
					<div className="max-w-prose mx-auto">
						...
						<div className="mt-4 text-amber-500/30 font-mono text-xs blink-cursor">
							{'[MINIFARM] przemek@minifarm-master: ~ $'}
						</div>
					</div>
				</div>
			</div>
			...
			<div className="max-w-prose mx-auto px-6 py-16 md:py-24">
				...
				<RevealSection>
					...
					<p className="text-sm text-amber-500/70 leading-relaxed mb-8">
						...
						application stack being tested. Client nodes pull container
				...
				<RevealSection>
					...
					<div className="bg-[#0d0d0a] border border-amber-500/15 rounded px-4 py-2.5 mb-8 inline-block">
						<code className="text-amber-400/90 text-sm font-mono amber-glow">
							...
							./minifarm.js test feature-branch
						</code>
					</div>
					<p className="text-sm text-amber-500/70 leading-relaxed mb-8">
